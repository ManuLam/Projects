...
# Runs at setup
setup([CANNY_JIGSAW_PATH, FULL_IMAGE_CANNY_JIGSAW_PATH, NORMAL_JIGSAW_PATH, ENRICHED_PIECES_PATH, ROTATED_PIECES_PATH, HARRIS_PIECES_PATH, FILTERED_JUNK_PATH, HOUGHP_PIECES_PATH])
